...
// Shadowing of variables declared using const take place below action
/*
    1. Variables declared using const globally and variables declaues using const in block scope has
different objects.
